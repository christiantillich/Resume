...
statistics:
  ...
  - {name: "`Segments / Clustering`", score: 4}
  - {name: "`Trad. Regression`", score: 6}
...
leadership roles. My latest passion has been experimenting combining traditional
ML identification with LLM diagnostics for truely automated, end-to-end
workflows. 
...
* Actively developing SPADE, an ML toolkit for identifying nonrepresentative
  spend and AI-assisted triage. 
* Developed and Deployed LayerScore, a ML method for similarity-scoring two JSON
...
* Developed and deployed Receipt Duplication Model to remove ~8k duplicate receipt matches per day from transcription records. 
