...
address: "https\\://goo.gl/maps/8ymuYhvJBpsiCDzp7?coh=178571&entry=tt"
phone: "847-863-7162"
website: "https\\://github.com/christiantillich/" #until I can figure out how to sanitize, we gotta escape special characters
email: "christian.tillich.walker\\@gmail.com"
statistics:
  - {name: "`General Stats & Opt`", score: 4}
  - {name: "`Segmentation / Clustering`", score: 4}
  - {name: "`Tree Methods - RF & XGB`", score: 5}
  - {name: "`Regression`", score: 6}
  - {name: "`Multivariate Methods`", score: 3}
  - {name: "`Bayesian Methods`", score: 2}
programming:
  - {name: "`AWS / Other Cloud`", score: 3}
  - {name: "`Git`", score: 4}
  - {name: "`Presentation`", score: 6}
  - {name: "`SQL`", score: 6}
  - {name: "`Python`", score: 5}
  - {name: "`R`", score: 4}
...
geometry: 
  - left = 4.6cm #Controlls overall sidebar length
  - top = 0.5cm 
  - right = 1.75cm
  - bottom = 0.2cm 
  - nohead 
...
Hello, I'm an analytically-minded Data Scientist with over a decade of 
experience in both model production, as well as deep-dive analysis making sense
of model behavior. I prefer roles with a strong hands-on component, and prefer
to lead through soft power and subject-matter-expertise as opposed to formal 
leadership roles. My latest passion has been experimenting with how LLMs can 
assist in fully-automated unsupervised learning

# Profile

I'm a Senior Data Scientist who gets excited about providing clear and honest
interpretation of data. I've developed and deployed predictive solutions both
Consumer Finance and Market Intelligence domains. My current projects focus on
AI-assisted modeling tasks, model development frameworks, and agentic systems.
I'm currently seeking a role where the things I build improves the lives of
others. 

# Patents

* Tillich, Christian. (Pending). Methods and Apparatus for Generating
  Intelligible Data Segments with Large Language Models (U.S. Patent No.
  19/307,575). U.S. Patent and Trademark Office.

# Work Experience

## Numerator \hfill Data Science: Product DS \hfill May 2020 - Present

* Actively developing LayerScore, a ML method for similarity-scoring two JSON
  blobs representing the same receipt transcription. 
* Developed and deployed AutoSeg, a fully-automated marketing segmentation solution. 
    * Engaged with stakeholders on painpoints of custom segmentations. 
    * Developed modern ML workflow to perform one-size-fits-most process for any subset of CPG goods.
    * Engineered AI-assisted interpretation of model findings, reducing segmentation turnaround time from months to hours. 
    * Developing beta program for midmarket clients who would otherwise not engage with custom segmentations. 
* Developed and deployed eployed Receipt Duplication Model to remove ~8k duplicate receipt matches per day from transcription records. 
    * Engaged with stakeholders on problematic trends in duplicate receipts impacting data quality.
    * Identified shortfalls in current methods, especially with online grocery substitution.
    * Created model to assess P(pair is duplicate | transcription features).
    * Worked with QA to validate impact in spite of partially censored target variable.
    * Model successfully deployed July 2024 with accuracy ~85%.
* Additional Modeling Experiments included:
    * Allocation v4, a method of assigning spend adjustments to households
    * Brand Strength model, a SEM tieing survey responses to actual market behaviors for participating panelists. 
* Developed numerous internal tools to assist with day-to-day DS functions
    * Python wrapper for Insights API to automate consultant tasks. Reduced execution time from hours to minutes while also reducing error.
...
* Built, documented, and maintained a shared automated reporting/preprocessing toolsets for the team. 
...
-------------------------------------------------------------------------------
University                        Degree              GPA           Years      
--------------------------------- ------------------- ------------- -----------
DePaul University                 MS Statistics       3.9/4.0       2012 - 2015
University of Illinois - UC       BS Physics          3.6/4.0       2004 - 2008
-------------------------------------------------------------------------------
