...
* Designed AutoSeg - A marketing segmentation tool with LLM-in-loop processes for naming and describing findings.
* Prototyped use of RNNs in extracting product features from photos. 
* Designed new version of Allocation - a distribution based model mapping Adjusted Dollars to Adjusted Households
* Designed experimental Brand Strength model, SEM model connecting survey responses to actual market behaviors for participating panelists. 
