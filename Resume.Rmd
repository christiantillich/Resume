...
* Designed AutoSeg - Instant marketing segmentation modeling with LLM-in-loop processes for naming and descriptions.
* Prototyped RNN-based tool to extract packaging type from images of CPGs. 
* Designed Brand Strength Model - an SEM relating survey attitudes to actual market behaviors for individual panelists.
